...
ECHO symstore add /f %BASE%\src\c\*\rtl\*.* /s C:\build-output\symbols\ZCO /t "Zimbra Migration Tools" /v "%BUILD_VERSION%" /c "%BUILD_DATE%"
symstore add /f %BASE%\src\c\Win32\rtl\*.* /s C:\build-output\symbols\ZCO /t "Zimbra Migration Tools x86" /v "%BUILD_VERSION%" /c "%BUILD_DATE%"
IF ERRORLEVEL 1 exit /B 3 
symstore add /f %BASE%\src\c\x64\rtl\*.* /s C:\build-output\symbols\ZCO /t "Zimbra Migration Tools x64" /v "%BUILD_VERSION%" /c "%BUILD_DATE%"
IF ERRORLEVEL 1 exit /B 3 
