...
private:
    ...
    ULONG 
        ...
        pr_fileas, pr_fileasID, 

        pr_business_address_city, pr_business_address_country, pr_business_address_postal_code, pr_business_address_state, pr_business_address_street, 
    ...
    typedef enum _ContactsPropIdx
    {
        ...
        N_FILEAS,N_FILEAS_ID, 
        
        N_BUS_CITY, N_BUS_COUNTRY, N_BUS_ZIP, N_BUS_STATE, N_BUS_STREET,
        N_CONTACT_USER1_IDX, 
        N_CONTACT_USER2_IDX, 
        N_CONTACT_USER3_IDX, 
        N_CONTACT_USER4_IDX,
        
        N_CONTACT_ONEOFFMEMEBRS_IDX, 
        ...
        N_ASSISTANT_TELEPHONE_NUMBER,
        N_OFFICE2_TELEPHONE_NUMBER, 
        N_COMPANY_MAIN_PHONE_NUMBER, 
        N_PRIMARY_TELEPHONE_NUMBER
    ...
    enum
    {
        ...
        C_MAIL1ADDRESS, C_MAIL1EID, C_MAIL1TYPE, C_MAIL1DISPNAME, 
        C_MAIL2ADDRESS, C_MAIL2EID, C_MAIL2TYPE, C_MAIL2DISPNAME, 
        C_MAIL3ADDRESS, C_MAIL3EID, C_MAIL3TYPE, C_MAIL3DISPNAME, 
        
        C_FILEAS, C_FILEASID, C_DISPLAY_NAME, 
        
        C_GIVEN_NAME, 
        C_HOME_ADDRESS_CITY, C_HOME_ADDRESS_COUNTRY, C_HOME_FAX_NUMBER, C_HOME_TELEPHONE_NUMBER, C_HOME2_TELEPHONE_NUMBER, C_HOME_ADDRESS_POSTAL_CODE, C_HOME_ADDRESS_STATE_OR_PROVINCE, C_HOME_ADDRESS_STREET,

        C_TITLE, C_SURNAME, C_MIDDLE_NAME, 
        ...
        C_OTHER_ADDRESS_CITY, C_OTHER_ADDRESS_COUNTRY, 
        
        C_PRIMARY_FAX_NUMBER,    // OTHER FAX
        
        C_OTHER_TELEPHONE_NUMBER, C_OTHER_ADDRESS_POSTAL_CODE, C_OTHER_ADDRESS_STATE_OR_PROVINCE, C_OTHER_ADDRESS_STREET, 
        
        C_PAGER_TELEPHONE_NUMBER,

        C_BUSINESS_ADDRESS_CITY, C_BUSINESS_ADDRESS_COUNTRY, C_BUSINESS_FAX_NUMBER, C_OFFICE_TELEPHONE_NUMBER, C_BUSINESS_ADDRESS_POSTAL_CODE, C_BUSINESS_ADDRESS_STATE, C_BUSINESS_ADDRESS_STREET, C_BUSINESS_HOME_PAGE, 
        ...
        C_DEPARTMENT, 
        C_NICKNAME, 
        C_ASSISTANT_TELEPHONE_NUMBER, 
        C_OFFICE2_TELEPHONE_NUMBER, 
        C_COMPANY_MAIN_PHONE_NUMBER, 
        C_PRIMARY_TELEPHONE_NUMBER, 
