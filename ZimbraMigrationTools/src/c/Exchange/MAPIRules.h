...
{
    RuleConditionInfo(): 
        m_ruleCondition(InvalidRuleCondition), 
        m_ruleConditionOp( InvalidConditionOp) {}
...
BOOL ConditionDetailsToInfo(LPCWSTR pwzTestName, LPCWSTR pwzConditionName, 
                            LPCWSTR pwzConditionComparison, LPCWSTR pwzTest, 
                            LPCWSTR pwzValue, BOOL bNegative,
...
public:
    ...
    bool ProcessRestrictions(CRule &rule, LPSRestriction pRestriction, bool bNegative, ULONG ulCallingType);
...
private:
    ...
    wstring GetDelocalizedFolderName(LPMAPIFOLDER pFolder, ULONG cbFldEntryId, LPENTRYID lpFldEntryId);
