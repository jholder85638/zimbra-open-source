...
ZmComposeController = function(container, mailApp, type, sessionId) {
	...
	ZmComposeController._createOpWarningMap();
};
 ...
 */
ZmComposeController.prototype._setView = function(params) {
...
ZmComposeController.prototype._getComposeMode = function(msg, identity, params) {
...
ZmComposeController.prototype._handleResponseSaveDraftListener = function(draftType, callback, result) {

	if (draftType === ZmComposeController.DRAFT_TYPE_AUTO && this._draftType == ZmComposeController.DRAFT_TYPE_NONE) {
...
// Map operations to the components that they affect. If the user has changed the content of a component that is going
// to be regenerated by an operation, we need to warn them.
ZmComposeController._createOpWarningMap = function() {

	ZmComposeController.OP_WARNING = {};
	ZmComposeController.OP_WARNING[ZmOperation.FORMAT_TEXT] = {};
	ZmComposeController.OP_WARNING[ZmOperation.FORMAT_TEXT][ZmComposeView.BC_SIG_PRE] = true;
	ZmComposeController.OP_WARNING[ZmOperation.FORMAT_TEXT][ZmComposeView.BC_DIVIDER] = true;
	ZmComposeController.OP_WARNING[ZmOperation.FORMAT_TEXT][ZmComposeView.BC_HEADERS] = true;
	ZmComposeController.OP_WARNING[ZmOperation.FORMAT_TEXT][ZmComposeView.BC_QUOTED_TEXT] = true;
	ZmComposeController.OP_WARNING[ZmOperation.FORMAT_TEXT][ZmComposeView.BC_SIG_POST] = true;
	ZmComposeController.OP_WARNING[ZmOperation.FORMAT_HTML] = ZmComposeController.OP_WARNING[ZmOperation.FORMAT_TEXT];
	ZmComposeController.OP_WARNING[ZmOperation.INC_BODY] = {};
	ZmComposeController.OP_WARNING[ZmOperation.INC_BODY][ZmComposeView.BC_QUOTED_TEXT] = true;
	ZmComposeController.OP_WARNING[ZmOperation.INC_ATTACHMENT] = ZmComposeController.OP_WARNING[ZmOperation.INC_NONE] =
		ZmComposeController.OP_WARNING[ZmOperation.INC_SMART] = ZmComposeController.OP_WARNING[ZmOperation.INC_BODY];
	ZmComposeController.OP_WARNING[ZmOperation.USE_PREFIX] = {};
	ZmComposeController.OP_WARNING[ZmOperation.USE_PREFIX][ZmComposeView.BC_HEADERS] = true;
	ZmComposeController.OP_WARNING[ZmOperation.USE_PREFIX][ZmComposeView.BC_QUOTED_TEXT] = true;
	ZmComposeController.OP_WARNING[ZmOperation.INCLUDE_HEADERS] = {};
	ZmComposeController.OP_WARNING[ZmOperation.INCLUDE_HEADERS][ZmComposeView.BC_HEADERS] = true;
	ZmComposeController.OP_WARNING[ZmOperation.ADD_SIGNATURE] = {};
	ZmComposeController.OP_WARNING[ZmOperation.ADD_SIGNATURE][ZmComposeView.BC_SIG_PRE] = true;
	ZmComposeController.OP_WARNING[ZmOperation.ADD_SIGNATURE][ZmComposeView.BC_SIG_POST] = true;
};

ZmComposeController.prototype._warnUserAboutChanges = function(op, okCallback, cancelCallback) {

	var cv = this._composeView,
		switchToText = (op === ZmOperation.FORMAT_TEXT && !AjxUtil.isEmpty(this._getBodyContent())),
		opMap = ZmComposeController.OP_WARNING[op],
		willLoseChanges = false;

	for (var comp in opMap) {
		if (cv.componentContentChanged(comp)) {
	...
	if (willLoseChanges || switchToText) {
		...
		var msg = willLoseChanges && switchToText ? ZmMsg.switchIncludeAndFormat : willLoseChanges ? ZmMsg.switchIncludeWarning : ZmMsg.switchToText;
