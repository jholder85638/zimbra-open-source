...
public class ResourceEquipmentManage extends AdminCommonTest {

	public ResourceEquipmentManage() throws HarnessException {
		logger.info("New "+ ResourceEquipmentManage.class.getCanonicalName());
