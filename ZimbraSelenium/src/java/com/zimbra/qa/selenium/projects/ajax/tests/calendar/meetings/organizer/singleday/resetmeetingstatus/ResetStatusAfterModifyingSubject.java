...
public class ResetStatusAfterModifyingSubject extends CalendarWorkWeekTest {	
	
	public ResetStatusAfterModifyingSubject() {
		logger.info("New "+ ResetStatusAfterModifyingSubject.class.getCanonicalName());
