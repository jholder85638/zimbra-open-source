...
public class ModifyFolderRetentionWhenSharingDisabled extends PrefGroupMailByMessageTest {

	public ModifyFolderRetentionWhenSharingDisabled() {
		logger.info("New " + ModifyFolderRetentionWhenSharingDisabled.class.getCanonicalName());
