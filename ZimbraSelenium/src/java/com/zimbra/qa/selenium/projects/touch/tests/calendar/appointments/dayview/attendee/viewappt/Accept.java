...
public class Accept extends CalendarWorkWeekTest {
	...
	@Bugs(ids = "95807")
	@Test(	description = "Accept a meeting using view appointment options", 
			groups = { "sanity" })
	...
	public void AcceptMeeting_01() throws HarnessException {
		...
		//String attendeeStatus = ZimbraAccount.AccountA().soapSelectValue("//mail:reply[@at='"+ app.zGetActiveAccount().EmailAddress +"']", "ptst");
		...
		//String myStatus = ZimbraAccount.AccountA().soapSelectValue("//mail:reply[@at='"+ app.zGetActiveAccount().EmailAddress +"']", "ptst");
