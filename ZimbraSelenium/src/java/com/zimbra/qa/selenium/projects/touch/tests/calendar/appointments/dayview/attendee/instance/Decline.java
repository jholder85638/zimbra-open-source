...
public class Decline extends CalendarWorkWeekTest {
	...
	public void DeclineMeeting_01() throws HarnessException {
        ...
        app.zPageCalendar.zListItem(Action.A_LEFTCLICK, Button.O_OPEN_INSTANCE_MENU, Button.O_DECLINE_MENU, apptSubject);
        ...
        // --- Check that the organizer shows the attendee as "NEEDS ACTION" for series ---
 		...
 		ZAssert.assertEquals(attendeeStatus, "NE", "Verify that the attendee shows as 'NEEDS DETION' for series");
 		
 		// --- Check that the attendee showing status as "NEEDS DETION" for series ---
 		...
 		ZAssert.assertNotNull(exceptId, "Verify that particular instance is declined properly");
