...
public class EveryWeek extends CalendarWorkWeekTest {

	public EveryWeek() {
		logger.info("New "+ EveryWeek.class.getCanonicalName());
	...
	public void EveryWeek_01() throws HarnessException {
		...
		// Go to next week and verify meeting invite is present
		for (int i=0; i<=6; i++) {
