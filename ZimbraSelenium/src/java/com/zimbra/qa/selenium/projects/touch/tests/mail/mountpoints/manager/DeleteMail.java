...
public class DeleteMail extends PrefGroupMailByMessageTest{
	...
	public void DeleteMail_01() throws HarnessException  {
		...
		FolderItem trash = FolderItem.importFromSOAP(ZimbraAccount.AccountA(), FolderItem.SystemFolder.Trash);
		MailItem mail = MailItem.importFromSOAP(ZimbraAccount.AccountA(), "subject:("+ subject +") is:anywhere");
