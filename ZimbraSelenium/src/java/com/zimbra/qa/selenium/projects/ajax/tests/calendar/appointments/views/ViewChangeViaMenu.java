...
public class ViewChangeViaMenu extends CalendarWorkWeekTest {
	...
	public void ViewChangeViaMenu_01() throws HarnessException {
        ...
        ZAssert.assertTrue(app.zPageCalendar.sIsElementPresent(Locators.CalendarViewWeekCSS), "Changed to day view");

		app.zPageCalendar.zListItem(Action.A_RIGHTCLICK, Button.O_VIEW_MENU, Button.O_VIEW_MONTH_SUB_MENU, "Month");
        ZAssert.assertTrue(app.zPageCalendar.sIsElementPresent(Locators.CalendarViewMonthCSS), "Changed to day view");
