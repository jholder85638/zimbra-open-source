...
public class CreateAppointmentWithzimbraFeatureGalEnabledFalse extends CalendarWorkWeekTest {

	public CreateAppointmentWithzimbraFeatureGalEnabledFalse() {
		logger.info("New "+ CreateAppointmentWithzimbraFeatureGalEnabledFalse.class.getCanonicalName());
