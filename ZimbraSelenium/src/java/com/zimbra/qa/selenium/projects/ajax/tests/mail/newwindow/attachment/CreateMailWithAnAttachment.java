...
public class CreateMailWithAnAttachment extends PrefGroupMailByMessageTest {

	public CreateMailWithAnAttachment() {
		logger.info("New "+ CreateMailWithAnAttachment.class.getCanonicalName());
	...
	public void CreateMailWithAnAttachment_01() throws HarnessException {
